define(['i18n!nls/lang'],function(i18n){
    ...
    var appFunc = {
        ...
        formatNum: function(num) {
            ...
            if (num > 999 && num < 1000000) return parseInt(num / 1000) + 'K';
            if (num >= 1000000 && num < 1000000000) return parseInt(num / 1000000) + 'M';
            if (num >= 1000000000 && num < 1000000000000) return parseInt(num / 1000000000) + 'T';

            return parseInt(num / 1000000000) + 'T';
        },
        formatAvatar:function(path) {
            if (path == null || path == '') return '/null.png';
            return path;
        },
