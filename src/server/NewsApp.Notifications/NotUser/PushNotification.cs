...
namespace NewsApp.Notifications.NotUser
{
    ...
    //    private List<INotificationPayload> _notifications = new List<INotificationPayload>();
    ...
    //    public List<string> SendToApple(List<INotificationPayload> queue)
    //    {
    ...
    //    private void SendQueueToapple(IEnumerable<INotificationPayload> queue)
    //    {
    //        int i = 1000;
    ...
    //    private static byte[] GeneratePayload(INotificationPayload payload)
    //    {
    //        try
    //        {
